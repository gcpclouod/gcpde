...
def send_success_email():
    ...
    """
    send_email(subject, body, 'lavu2016hani@gmail.com') # pls give your email address
...
# Define the DAG
with DAG(
    dag_id="gcs_to_bigquery_etl_job_final_updated_dagg",
    ...
    gcs_sensor = GCSObjectsWithPrefixExistenceSensor(
        task_id='gcs_sensor',
        bucket='gcpclouddataengineeringbatch32', # Please change the bucket name
    ...
    # Task 7: End task using EmptyOperator with modified trigger rule
...
# Observation # DAG # Succeful Execute -- What do you need? What are the depencies we should meet/clear?