...
# Define the DAG
with DAG(
    dag_id="gcs_to_bigquery_etl_job_updated_dag",
    ...
    # Task 5: Send success email after data is loaded into BigQuery
    ...
    load_data_task >> send_success_email_task  # Send success email after data is loaded
