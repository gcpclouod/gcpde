...
def run():
    ...
    google_cloud_options.staging_location = 'gs://dataflow_flex_template_demo_bucket_12345/staging'
    google_cloud_options.temp_location = 'gs://dataflow_flex_template_demo_bucket_12345/temp'
